...
function setMeal(){
    ...
    xhttp.open("GET", `https://open.neis.go.kr/hub/mealServiceDietInfo?KEY=02523639969a4d6a961200f98959e647&ATPT_OFCDC_SC_CODE=J10&SD_SCHUL_CODE=7531328&MLSV_YMD=${year}${month}${date}`, true);
    xhttp.send();
}
